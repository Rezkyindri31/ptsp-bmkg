...
import useTampilanJasaKlimatologi from "@/hooks/Backend/useTampilanJasaKlimatologi";
...
export default function JasaKlimatologi() {
  const { produkJasaKlimatologi, loading, error } =
    useTampilanJasaKlimatologi();
  ...
  const {
    ...
    prevPage,
    getItemProps,
  } = usePagination(produkJasaKlimatologi);
